      ...
      <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-20 items-center w-full">
        ...
        >
          ...
          <div className="absolute -bottom-8 -left-5 md:-left-8 size-24 md:size-40 border border-foreground/20 rounded-full flex flex-col items-center justify-center p-4 bg-foreground z-10 text-center backdrop-blur-md">
            <span className="text-brand-light text-xs uppercase tracking-widest mb-1 opacity-60">
              Est.
            </span>
            <span className="text-brand-light font-display font-bold text-2xl md:text-3xl">
              2023
            </span>
          </div>
        </div>
        <div className="space-y-8">
          ...
          <div className="flex gap-6 py-4">
            <SocialLink href="#" icon={<SiInstagram size={20} />} />
            <SocialLink href="#" icon={<SiX size={20} />} />
            <SocialLink
              href="#"
              icon={
                <svg
          ...
          <Button
            ...
            className="pt-4 border-b border-foreground text-xs uppercase tracking-widest font-bold cursor-pointer pb-1 active:pb-2 transition-all"
            href="#contact"
